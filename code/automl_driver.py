...
workspace_name = "unique-name-global" # PLACEHOLDER
subscription_id = "1920a3d2-c38d-45c2-840c-54a8eb31155c" # PLACEHOLDER
resource_group = "frauddetection" # PLACEHOLDER
experiment_name = "ccd-1" # PLACEHOLDER
iteration = "40"  # PLACEHOLDER
run_id = "AutoML_edd8519c-27df-4b5a-8e1e-15726d40531c_40"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'compute_target':'ccd-comp','enable_dnn':False,'enable_code_generation':False,'experiment_exit_score':None,'experiment_timeout_minutes':360,'featurization':'auto','is_timeseries':False,'iteration_timeout_minutes':360,'max_concurrent_iterations':1,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'ccd-1','path':'./sample_projects/ccd-1','primary_metric':'AUC_weighted','region':'southeastasia','resource_group':'frauddetection','subscription_id':'1920a3d2-c38d-45c2-840c-54a8eb31155c','task_type':'classification','validation_size':None,'test_size':None,'vm_type':'STANDARD_DS3_V2','workspace_name':'unique-name-global','label_column_name':'Class','positive_label':None,'enable_batch_run':True,'enable_run_restructure':True} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'AUC_weighted','ensemble_iterations':15,'is_timeseries':False,'name':'ccd-1','compute_target':'ccd-comp','subscription_id':'1920a3d2-c38d-45c2-840c-54a8eb31155c','region':'southeastasia'}\",\"ensemble_run_id\":\"AutoML_edd8519c-27df-4b5a-8e1e-15726d40531c_40\",\"experiment_name\":\"ccd-1\",\"workspace_name\":\"unique-name-global\",\"subscription_id\":\"1920a3d2-c38d-45c2-840c-54a8eb31155c\",\"resource_group_name\":\"frauddetection\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"a3ecc11c-5774-4d38-b15f-e14fc1fa6b94\"}}" # PLACEHOLDER
